...
public class EntityTypeRegistry {
    ...
    public static final RegistrySupplier<EntityType<FloatingDebrisEntity>> FLOATING_DEBRIS = registerEntityType("floating_debris", () -> EntityType.Builder.of(FloatingDebrisEntity::new, MobCategory.MISC).sized(2f, 2.5f).build(LilisLuckyLuresIdentifier.identifier("floating_debris").toString()));
    public static final RegistrySupplier<EntityType<FloatingBooksEntity>> FLOATING_BOOKS = registerEntityType("floating_books", () -> EntityType.Builder.of(FloatingBooksEntity::new, MobCategory.MISC).sized(2f, 2.5f).build(LilisLuckyLuresIdentifier.identifier("floating_books").toString()));
    public static final RegistrySupplier<EntityType<RiverFishPoolEntity>> RIVER_FISH_POOL = registerEntityType("river_fish_pool", () -> EntityType.Builder.of(RiverFishPoolEntity::new, MobCategory.MISC).sized(2f, 2.5f).build(LilisLuckyLuresIdentifier.identifier("river_fish_pool").toString()));
    public static final RegistrySupplier<EntityType<OceanFishPoolEntity>> OCEAN_FISH_POOL = registerEntityType("ocean_fish_pool", () -> EntityType.Builder.of(OceanFishPoolEntity::new, MobCategory.MISC).sized(2f, 2.5f).build(LilisLuckyLuresIdentifier.identifier("ocean_fish_pool").toString()));
